...
const WordViewer = dynamic(() => import("./word-viewer-client-component"), {
  ssr: false,
});

interface EnhancedWordViewerProps {
  url: string;
}

const EnhancedWordViewer: React.FC<EnhancedWordViewerProps> = ({ url }) => {
...
export default EnhancedWordViewer;
